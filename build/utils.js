...
const processAnswers = (answers) => {
    ...
    for (let index = 0; index < boardAnswers.length; index++) {
...
export { generateGameId, updateAllPlayersReadyStatus, getCurrentTime, drawDebug, boolConv, newPlayerObj, newGameObj, updateAllPlayersAnsweredStatus, processAnswers, getAnswers, getMiddleIndex, getHighestOdds, isHost, CSVToJSON, getUniqueID, };
